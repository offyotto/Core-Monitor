...
- Core Monitor is not available on the Mac App Store (obviously because of Apple-Sandbox restrictions for the mac app store and restricted use of ANY private api in mac app store apps.)
