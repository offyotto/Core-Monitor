    ...
    private var allSections: [HelpSection] {
        [
            ...
            HelpSection(id: "menubar", title: "Menu Bar Items and Popovers", icon: "menubar.rectangle", keywords: [
                "menu bar", "popover", "visible items", "cpu", "fan", "rpm", "memory", "disk", "temperature",
                ...
                HelpCard {
                    ...
                    HelpBullet(text: "Use `System` → `Menu Bar` to choose which of the CPU, Fan, Memory, Disk, and Temperature items stay visible.")
