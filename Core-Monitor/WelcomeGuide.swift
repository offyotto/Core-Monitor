...
private let guideSteps: [GuideStep] = [
    GuideStep(
        ...
        subheadline: "See your Mac at a glance.",
        body: "Core-Monitor shows temperatures, memory pressure, fan behavior, power draw, and other live system readings for your Apple Silicon Mac.",
        bullets: [
            ("thermometer.medium",    .wgAmber,  "Live CPU, GPU, and memory readings"),
            ("fan.fill",              .wgBlue,   "Optional fan control"),
            ("rectangle.on.rectangle", .wgGreen, "Configurable Touch Bar items"),
    ...
    GuideStep(
        ...
        iconColor: .wgAmber,
        headline: "Thermals and Metrics",
        subheadline: "Watch the system as it changes.",
        body: "The dashboard updates once per second and keeps short histories so you can spot spikes without leaving the app.",
        bullets: [
            ("cpu.fill",              .wgAmber,  "P-core and E-core usage, plus CPU temperature"),
            ("memorychip",            .wgBlue,   "Memory pressure with a wired and active breakdown"),
            ("chart.line.uptrend.xyaxis", .wgGreen, "Short rolling history graphs"),
    ...
    GuideStep(
        ...
        subheadline: "Quiet when idle. Ready under load.",
        body: "Fan control supports Smart, Silent, Balanced, Performance, Max, Manual, and System modes. Writes go through the bundled helper when that path is installed.",
        bullets: [
            ("bolt.fill",             .wgAmber,  "Smart mode ramps earlier under sustained load"),
            ("fanblades.fill",        .wgBlue,   "Balanced, Performance, and Max quick modes"),
    ...
    GuideStep(
        ...
        iconColor: .wgPurple,
        headline: "Touch Bar",
        subheadline: "Keep it simple, or make it yours.",
        body: "On supported Macs, Core-Monitor can replace the system Touch Bar with status items, launchers, command buttons, and hardware widgets.",
        bullets: [
            ("rectangle.on.rectangle", .wgGreen, "Light and dark Touch Bar themes"),
            ("rectangle.3.group",     .wgBlue,   "Reorder or remove items in the app"),
            ("cloud.sun.rain.fill",   .wgAmber,  "Weather uses Apple WeatherKit"),
            ("location.fill",         .wgGreen,  "Location access is only needed for weather"),
            ("hand.tap",              .wgPurple, "Tap Weather for rain details"),
            ("wrench.and.screwdriver", .wgPurple, "Switch back to the system Touch Bar at any time"),
        ]
    ),
    GuideStep(
        id: 4,
        ...
        iconColor: .wgGreen,
        headline: "Ready.",
        subheadline: "You can change this later.",
        body: "The dashboard is live. Explore the thermal, power, fan, and Touch Bar sections, or switch to Basic Mode for a lighter view.",
        bullets: [
            ("sidebar.left",          .wgAmber,  "Dashboard sections collapse as needed"),
            ("fan.fill",              .wgBlue,   "Fan Control is lower in the dashboard"),
            ("lock.shield",           .wgPurple, "Fan writes require the helper"),
            ("questionmark.circle",   .wgGreen,  "This guide appears the first time you open the app"),
        ]
    ),
]
