# File: downloads/Core-Monitor-11.2.6.zip
...
| Field | Value |
| --- | --- |
| Source path | [`downloads/Core-Monitor-11.2.6.zip`](../../../downloads/Core-Monitor-11.2.6.zip) |
...
| Commit | Date | Subject |
| --- | --- | --- |
| `e9a03c5` | 2026-04-08 | Publish missing release archives |
