...
- The FAQ’s Support Package flow is explicit and support-oriented: it gathers anonymized system profiling, app logs/preferences, crash logs, screenshots, and hardware state in one export.
...
- Support exports should stay one-click, scoped, and readable enough that users can attach them confidently without opening a second diagnostics workflow.
...
- Keep diagnostics exports tightly scoped and human-readable; TG Pro’s support package raises user expectations for what “good supportability” looks like in this category.
