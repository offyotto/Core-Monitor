...
This release adds the new **Rescue** dashboard page for advanced Apple Silicon hardware diagnostics. It is designed for safe USB-C controller triage after cases where an ACE/CD3217 controller reports firmware 0 or gets stuck outside normal APP firmware.
