...
`Kernel Panic` now bundles three local MP3 phase tracks. To keep the app small, the shipped files are compact local MP3 copies derived from the original CC0 OpenGameArt tracks below.

- `kernelpanic_phase1.mp3`
  Source: [8-Bit Curious Theme](https://opengameart.org/content/8-bit-curious-theme)
  Author: emanresU
  License: CC0
  In-game use: phase 1 warmup + ILOVEYOU

- `kernelpanic_phase2.mp3`
  Source: [Charge!](https://opengameart.org/content/charge)
  Author: Centurion_of_war
  License: CC0
  In-game use: phase 2 warmup + WannaCry

- `kernelpanic_phase3.mp3`
